package org.krish.assignment6.dao;
...
public class EmployeeDAO {
    ...
    private static void initEmps() {
        Employee emp1 = new Employee("E01", "Peter", "Clerk");
        Employee emp2 = new Employee("E02", "Tony", "Salesman");
        Employee emp3 = new Employee("E03", "Kent", "Manager");
